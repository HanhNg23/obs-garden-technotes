...
1. Session Management's Components
	...
	- `SessionManagementFilter` - [[Software Knowledges/Programming Language/Java/Java Framework/Java Spring Security/Spring Security 6.2.0#^Session-Management-Filter\|#^Session-Management-Filter]]
	- > [!Caution]
...
- Introduction
	...
	- ---> <span style="color:#d4a216">SprSe provides the necessary hooks for these operations to take place and has 2 concrete remember-me implementations</span>
		- Once uses hashing to preserve the security of cookie-based tokens - [[Software Knowledges/Programming Language/Java/Java Framework/Java Spring Security/Spring Security 6.2.0#^Simple-Hash-Based-Token-Approach\|#^Simple-Hash-Based-Token-Approach]]
